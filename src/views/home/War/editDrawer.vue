	...
	<el-drawer title="详情" :visible.sync="drawer" :direction="direction" append-to-body :before-close="handleClose">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px">
			...
			<el-form-item label="攻方兵力" prop="aggressorTroops">
				<el-input v-model="ruleForm.aggressorTroops" placeholder="请输入攻方兵力" type="textarea" :rows="2"></el-input>
			</el-form-item>
			<el-form-item label="守方兵力" prop="defenseTroops">
				<el-input v-model="ruleForm.defenseTroops" placeholder="请输入守方兵力" type="textarea" :rows="2"></el-input>
			</el-form-item>
			<el-form-item label="攻方主要装备" prop="aggressorEquip">
				<el-input v-model="ruleForm.aggressorEquip" placeholder="请输入攻方主要装备" type="textarea" :rows="2"></el-input>
			</el-form-item>
			<el-form-item label="守方主要装备" prop="defenseEquip">
				<el-input v-model="ruleForm.defenseEquip" placeholder="请输入守方主要装备" type="textarea" :rows="2"></el-input>
			</el-form-item>
			...
			<el-form-item label="战损及战果" prop="warResult">
				<el-input v-model="ruleForm.warResult" placeholder="请输入战损及战果" type="textarea" :rows="2"></el-input>
			</el-form-item>
			<el-form-item label="来源" prop="source">
				<el-input v-model="ruleForm.source" placeholder="请输入来源"></el-input>
			</el-form-item>
			<el-form-item label="原文地址" prop="url">
				<el-input v-model="ruleForm.url" placeholder="请输入原文地址"></el-input>
			</el-form-item>
			<el-form-item label="译文" prop="translation">
				<!-- 内容录入 显示 -->
				<BasicEditor v-model="ruleForm.translation" />
				<!-- <el-input v-model="ruleForm.translation" placeholder="请输入译文" type="textarea" :rows="2"></el-input> -->
			</el-form-item>
			<el-form-item label="原文" prop="originalText">
				<BasicEditor v-model="ruleForm.originalText" />
				<!-- <el-input v-model="ruleForm.originalText" placeholder="请输入原文" type="textarea" :rows="2"></el-input> -->
			</el-form-item>
	...
	methods: {
		async openDrawer(id) {
			if (id) {
				...
				this.ruleForm = Object.assign({}, data, { source: "维基百科", registerTime: data.fightTime })
			}
			this.drawer = true
		},
		handleClose() {
